\begin{filecontents*}{rescommgraph}
...
If there are no self-loops, that is, there are no edges incident on sets $ \{ n_j, n_j\} \in V, j \in {1, 2, ..., k} $ then we call the graph \textit{simple}.
