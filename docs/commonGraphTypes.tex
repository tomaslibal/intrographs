...
Bipartite graph's vertex set is divided into two sets in which vertices from one set can be adjacent only to vertices in the other set. This is a special case of the \textit{k}--partite graph where $ k = 2 $.
